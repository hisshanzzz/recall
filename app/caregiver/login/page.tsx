...
export default function CaregiverLoginPage() {
  ...
  const VALID_EMAIL = "caregiver@recall.com"
  const VALID_PASSWORD = "caregiver123"
  ...
  return (
    <div className="min-h-screen bg-creme flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden text-center mb-12">
            ...
            <p className="text-sm text-leather/50 mt-1">Caregiver Portal</p>
          </div>

          {/* Welcome text */}
          <div className="mb-10">
            <h2 className="text-2xl font-semibold text-coffee mb-2">Caregiver Portal</h2>
            <p className="text-leather/60">Sign in to manage your patients</p>
          </div>
          ...
          <button
            type="button"
            onClick={() => { setEmail("caregiver@recall.com"); setPassword("caregiver123") }}
          ...
          >
            ...
            <p className="text-xs text-leather/70 font-mono">caregiver@recall.com / caregiver123</p>
          </button>
        </div>
      </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-bl from-coffee via-maroon to-coffee" />
        <div className="absolute bottom-1/4 -left-20 w-80 h-80 bg-peach/20 rounded-full blur-3xl" />
        <div className="absolute top-1/4 -right-20 w-96 h-96 bg-pine/10 rounded-full blur-3xl" />
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <p className="text-xl text-creme/60 leading-relaxed max-w-md">
            Supporting care through meaningful connections.
          </p>
        </div>
      </div>
    </div>
